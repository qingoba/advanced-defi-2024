...
contract UniswapV2Twap {
        ...
        returns (uint256 price0Cumulative, uint256 price1Cumulative)
    {
        ...
        if (blockTimestampLast != blockTimestamp) 
        {
            ...
            unchecked {
                ...
                FixedPoint.uq112x112 memory spot_price_0 = FixedPoint.fraction(reserve1, reserve0);
                FixedPoint.uq112x112 memory spot_price_1 = FixedPoint.fraction(reserve0, reserve1);

                price0Cumulative += uint256(spot_price_0._x) * dt;
                price1Cumulative += uint256(spot_price_1._x) * dt;
            }
        }
    }
    ...
    function update() external {
        ...
        require(dt >= MIN_WAIT, "dt < MIN_WAIT");
        ...
        unchecked {
            ...
            uint256 diff0 = price0Cumulative - price0CumulativeLast;
            uint256 diff1 = price1Cumulative - price1CumulativeLast;
            price0Avg = FixedPoint.uq112x112(uint224(diff0 / dt));
            price1Avg = FixedPoint.uq112x112(uint224(diff1 / dt));
        }
        ...
        returns (uint256 amountOut)
    {
        ...
        require(tokenIn == token0 || tokenIn == token1, "token not correct");
